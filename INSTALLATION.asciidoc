...
La base MongoDB est contrôlée via les drivers mongoDB Java (Cf DAOImpl). Ces drivers génère la base de données et les collections si celles-ci n'existent pas .
